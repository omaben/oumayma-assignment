...
import { HandDeposit as handDepositIcon } from '@phosphor-icons/react/dist/ssr/HandDeposit';
import { Download, Globe, Money, Upload, User, UsersThree, Wallet } from '@phosphor-icons/react';
...
export const icons = {
  ...
  gear: GearIcon,
  users: UsersIcon,
  withdraw: handWithdrawIcon,
  deposit: handDepositIcon,
