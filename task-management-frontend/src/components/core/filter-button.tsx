...
export interface FilterContextValue<T = unknown> {
  ...
  onApply: (value: unknown, valueTo?: unknown) => void;
  onClose: () => void;
  open: boolean;
  value?: T;
  valueTo?: T;
...
export function FilterButton({
  ...
  return (
    <FilterContext.Provider
      value={{ anchorEl: anchorRef.current, onApply: handleApply, onClose: handleClose, open, value, valueTo }}
    >
      <Button
        sx={{ ...sx }}
        color="secondary"
...
export function FilterPopover({
  ...
  return (
    <Popover
      ...
      sx={{ '& .MuiPopover-paper': { mt: '4px', width: width ?? '280px' } }}
    >
